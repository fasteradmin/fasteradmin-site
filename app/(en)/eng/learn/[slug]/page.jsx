...
export function generateMetadata({ params }) {
  ...
  return pageMetadata({
    path: `/eng/learn/${post.slug}`,
    // Every post published so far has a Dutch translation at the same slug
    // (2026-09-13) — if that stops being true for some future post, this
    // needs a per-post flag rather than being unconditional.
    languages: {
      nl: `/learn/${post.slug}`,
      ...
      <article>
        <section className="bg-white">
          <div className="container-site py-16 lg:py-24">
            <Link href="/eng/learn/" className="text-sm text-ink-muted hover:text-brand">
              ← All writing
            </Link>
