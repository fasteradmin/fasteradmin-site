...
/**
 * English keeps its original two-column hero with the receipt image.
 *
 * Dutch got a full restyle (2026-09): a full-bleed banner photo with rounded
 * bottom corners, a solid-to-transparent panel fade behind the copy (the
 * photo's own built-in fade is too gradual on its own — see the git history
 * on this file if that gradient ever needs retuning), and a composed GSAP
 * word-stagger on the headline. The secondary "Zie een systeem..." button is
 * intentionally gone for now; a replacement CTA is coming later.
 */
const COPY = {
  en: {
      ...
      >
        ...
        <div className="absolute inset-0 hidden md:block">
          <Image
            ...
            alt="Ondernemer aan zijn bureau, kijkt peinzend naar links terwijl hij aan zijn baard trekt"
            fill
            priority
        ...
        <div className="relative flex min-h-0 items-center md:min-h-[660px]">
          <div className="w-full max-w-[560px] px-6 py-14 sm:px-10 md:pl-[100px] md:pr-10">
            ...
            <p data-fade className="body-base mt-5 max-w-[430px] text-grey-600">
              {t.body}
            </p>
